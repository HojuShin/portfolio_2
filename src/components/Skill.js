                ...
                <div className="skill-desc-box">
                    ...
                    >
                        <div className="skill-desc">
                            <div className="skill-desc-title">
                                <h4>Basic</h4>
                            </div>
                            <div className="skill-desc-text">
                                <h4>HTML, CSS, JavaScript에 능숙하여 웹 페이지를 구축하고 디자인하며, 동적이고 상호작용하는 기능을 구현할 수 있습니다.</h4>
                            </div>
                            <div className="skill-desc-logo">
                                <ul>
                                    <li>
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="80" height="70" viewBox="0 0 48 48">
                    ...
                    >
                        <div className="skill-desc">
                            ...
                            <div className="skill-desc-text">
                                <h4>React및 Next.js를 활용하여 UI를 작은 단위로 나누어 구조를 형성하고 재사용 가능한 컴포넌트로 설계합니다.</h4>
                            </div>
                            <div className="skill-desc-logo">
                                <ul>
                                    <li>
                                    ...
                                    <li>
                                        <svg className="nextjs" xmlns="http://www.w3.org/2000/svg" height="70" preserveAspectRatio="xMidYMid" viewBox="0 0 512 309" width="85">
                    ...
                    <ScrollAnimation
                        ...
                        repeat={false}
                    >
                        <div className="skill-desc skill-desc-bottom">
                            <div className="skill-desc-title">
                                <h4>Development tools</h4>
                            </div>
                            <div className="skill-desc-text">
                                <h4>VS Code, Git, npm을 통해 효율적이고 협업 가능한 웹 개발 환경을 구축합니다.</h4>
                            </div>
                            <div className="skill-desc-logo">
                                <ul>
                                    <li>
