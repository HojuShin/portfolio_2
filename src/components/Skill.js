                ...
                <div className="skill-desc-box">
                    <div className="skill-desc">
                        ...
                        <div className="skill-desc-text">
                            <h4>HTML, CSS, JavaScript를 조합하여 효과적이고 직관적인 사용자 경험을 제공하는 웹페이지를 디자인하고 구현합니다.</h4>
                        </div>
                    ...
                    <div className="skill-desc">
                        ...
                        <div className="skill-desc-text">
                            <h4>UI를 작은 단위로 나누어 구조를 형성하고 재사용 가능한 컴포넌트로 설계합니다.</h4>
                        </div>
                        <div className="skill-desc-logo">
                            <ul>
                                <li>
                    ...
                    <div className="skill-desc skill-desc-bottom">
                        ...
                        <div className="skill-desc-text">
                            <h4>VS Code, npm, Git을 활용하여 효율적이고 협업 가능한 웹 개발 환경을 구축합니다.</h4>
                        </div>
                        <div className="skill-desc-logo">
                            <ul>
                                <li>
